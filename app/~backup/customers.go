...
func init() {
	...
	crud.Handler(crud.CrudHandler {
		...
		Action: "customers",
		KeyName: "id",
		ListDataSource: "DBApp.GetCustomers",
		EditDataSource: "DBApp.GetCustomers",
		UpdateDataSource: "DBApp.AddCustomer",
	...
	dbase.Connections["DBApp"].NewCommand("GetCustomers", "GetCustomers", "procedure", func(cmd dbase.ICommand) {
	...
	dbase.Connections["DBApp"].NewCommand("AddCustomer", "AddCustomer", "procedure", func(cmd dbase.ICommand) {
